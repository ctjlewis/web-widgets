...
export const maybeInstallStylesheet = () => {
  if (!STYLESHEET.sheet) {
    // const existing = document.getElementById('ww-stylesheet');
...
export class Inheritable {
  ...
  /**
   * Export all inheritable styles for this class.
   *
...
export class Widget extends Inheritable {
  ...
  constructor(...children) {
     ...
     */
    this.tag = this.constructor.tag || (
            PRODUCTION ? 'w' : this.constructor.name
    );
