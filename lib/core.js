...
export class Inheritable {
  ...
  constructor() {
     ...
     * Defined to prevent inlining by compiler.
     *
     * @type {string}
     */
  ...
  static get classNames() {
    ...
    if (inheritedClasses) classNames.push(...inheritedClasses);

    /** Cache the styles for this class. */
    this.cacheStyles();
    /** Cache the class names for this class. */
