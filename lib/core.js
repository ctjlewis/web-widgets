 ...
 * @return {undefined}
 */
const debugLog = (name, ...args) => console.log(`${name}()`, ...args);
 ...
 * @return {void}
 */
export const addStylesheet = () => document.head.appendChild(
...
export function Mix(...classes) {
  const mixed = class extends Widget {
     ...
     *
     * @param  {...any} classes The classes to inherit from.
     */
...
class Widget extends Inheritable {
  ...
  append(child) {
    ...
    if (WIDGETS_FLAGS.DEBUG) debugLog('append', arguments);
  ...
  applyAttributes() {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('applyAttributes', arguments);
  ...
  applyClasses() {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('applyClasses', arguments);
  ...
  applyElement() {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('setElement', arguments);
  ...
  applyStyles() {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('applyStyles', arguments);
  ...
  build() {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('build', arguments);
  ...
  render(target = this.element) {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('render', arguments);
  ...
  replace(node) {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('replaceElement', arguments);
  ...
  replaceText(text) {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('setTextNode', arguments);
  ...
  setAttributes(attributes) {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('setAttributes', arguments);
  ...
  setClasses(...args) {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('setClass', arguments);
  ...
  setStyles(styles) {
    /* eslint-disable-next-line prefer-rest-params */
    if (WIDGETS_FLAGS.DEBUG) debugLog('setStyles', arguments);
