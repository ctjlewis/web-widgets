 ...
 * @extends Widget
 */
export class CenteredElement extends Widget {
  static get styles() {
    return `
            display: flex;
            align-items: center;
 ...
 * @extends Widget
 */
export class CenteredHeading1 extends Mix(Heading1, CenteredElement) {}
 ...
 * @extends Widget
 */
export class CenteredHeading2 extends Mix(Heading2, CenteredElement) {}
 ...
 * @extends Flex
 */
export class CenteredCard extends Mix(CenteredElement, Card, FullWidth) {}
...
export class WebPage extends UnstyledElement {
  ...
  exportStylesheet() {
    debugLog('Exporting WebPage stylesheet...');
