...
export class Elevation1 extends Widget {
  static styleString =  `box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.14),` +
...
export class Elevation2 extends Widget {
  static styleString =  `box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14),` +
...
export class Block extends Widget {
  static styleString =  `display: block;`;
}
...
export class Padding extends Widget {
  static styleString =  `padding: 16px;`;
}
...
export class Relative extends Widget {
  static styleString =  `position: relative;`;
}
...
export class Absolute extends Widget {
  static styleString =  `position: absolute;`;
}
...
export class Fixed extends Widget {
  static styleString =  `position: fixed;`;
}
...
export class Heading1 extends TextWidget {
  static tag = `h1`;
  static styleString =  `font-size: 2rem`;
}
...
export class Heading2 extends TextWidget {
  static tag = `h2`;
  static styleString =  `font-size: 1rem`;
}
...
export class Column extends Expanded {
  static styleString =  `flex-direction: column !important;`;
}
...
export class Row extends Expanded {
  static styleString =  `flex-direction: row !important;`;
}
...
export class DarkText extends TextWidget {
  static styleString =  `color: black;`;
}
...
export class BoldText extends TextWidget {
  static styleString =  `font-weight: bold;`;
}
...
//   static styleString =   `justify-content: space-around;`;
//   }
// }
...
export class BottomBar extends Widget {
  static styleString =  `height: 80px;`;
}
...
export class GreyText extends DarkText {
  static styleString =  'opacity: 0.5;';
}
...
export class HTMLWidget extends Widget {
  static tag = 'html';
  static styleString =  VIEWPORT_CSS;
  ...
  exportStylesheet() {
    ...
    frozenStyles.appendChild(
        document.createTextNode(GLOBAL_STYLES.join('\n')),
    );
...
export class SpaceEvenly extends Expanded {
  static styleString =  `justify-content: space-evenly;`;
}
