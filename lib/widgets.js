...
export class BodyWidget extends FadeIn {
  ...
  build() {
    ...
    this.append(
         ...
         *
         * To make sure there is an initial blank state to transition from, we
         * ask for an animation frame, and then schedule our updates after the
         * first paint.
         */
        new Script(
            ...
            }||[];b.length;)requestAnimationFrame(b.pop());});`,
        ).setAttributes({
          defer: true,
        }),
    );
